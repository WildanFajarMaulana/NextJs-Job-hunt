...
const resourceLinks = ["Helps Docs", "Guide", "Updates", "Constact Us"];
...
const Footer: FC<FooterProps> = ({}) => {
  return (
    <div className="bg-slate-900 px-32 pt-16 pb-11">
      <div className="flex flex-row items-start justify-between">
        <div>
          ...
          <div className="text-muted mt-8">
            Lorem ipsum, dolor sit amet consectetur <br /> adipisicing elit. Blanditiis
            odit optio unde ipsa.
          </div>
        </div>
        <div>
      ...
      <Separator className="mt-20 mb-11 bg-gray-600" />
      <div className="flex flex-row items-center justify-between">
        <div className="text-slate-600">
                20221 @ JobHuntly. All Right reserved
        </div>
